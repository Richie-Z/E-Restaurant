                   ...
                   <div class="col-md-7">
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td  class="p-2"><a href="{{ route('admin.transaksi.cek',['id' => $order->id]) }}" onclick="return confirm('Yakin ingin mengonfirmasi pesanan ini?')" class="btn btn-primary mt-1">Konfirmasi pesanan</a><br>
                            <small>Klik tombol ini jika menu tersedia</small>
                            </td>
                        </tr>
                        @endif
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td  class="p-2">
                            <form action="{{ route('admin.transaksi.inputpesanan',['id' => $order->id]) }}" method="POST">
                                @csrf
                            <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" placeholder="Input Pesanan" aria-label="Recipient's username" aria-describedby="basic-addon2" name="no_pesanan" required>
