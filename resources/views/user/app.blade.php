...
<head>
    <title>Rumah Makan Richie &mdash; Rumah Makan Berkualitas </title>
    <meta charset="utf-8">
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
                            <form action="{{ route('user.menu.cari') }}" method="get" class="site-block-top-search">
                                @csrf
                        ...
                        <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
                            <div class="site-logo">
                                <a href="/" class="js-logo-clone">Rumah Makan</a>
                            </div>
                        </div>
                                        ...
                                        @if (Route::has('login'))
                                            @auth
                                                <li>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            <a class="dropdown-item" href="/keranjang"><i
                                                                    class="mdi mdi-logout mr-2 text-primary"></i>
                                                                Keranjang</a>
                                                ...
                                                <li>
                                                    ...
                                                    ->first();
                                                    ?>
                                                    <a href="{{ route('user.order.index') }}" class="site-cart">
            ...
            <nav class="site-navigation text-right text-md-center" role="navigation">
                <div class="container">
                    <ul class="site-menu js-clone-nav d-none d-md-block">
                        ...
                        <li class="{{ Request::path() === 'menu' ? '' : '' }}"><a
                                href="{{ route('user.menu') }}">Menu</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6">
                        <div class="block-5 mb-5">
                            ...
                            <ul class="list-unstyled">
                                <li class="address">Jalan Pelatuk Palangkaraya</li>
                                <li class="phone"><a
                                        href="https://api.whatsapp.com/send?phone=0895410535786&text=Hallo%20Richie">+62
                                        895-4105-35786</a></li>
                                <li class="email">zakariarichie@gmail.com</li>
                            </ul>
                        </div>
