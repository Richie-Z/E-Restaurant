...
<div class="site-section">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-warning text-white">Belum di Cek</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-warning text-white">Sudah di Cek</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-warning text-white">Sudah di bayar</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
